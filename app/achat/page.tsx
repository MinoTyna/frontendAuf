...
export default function AchatPage() {
  ...
  if (
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gradient-to-br from-red-400/50 to-blue-600/90 ">
        <LoadingSpinner />
      </div>
    );
  }
  return (
    <>
      <div className="h-full  flex flex-col gap-6   bg-gradient-to-br from-red-400/50 to-blue-600/90">
        {/* Section ajout achat */}
        ...
        {showPaiementModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="md:w-1/2 w-full max-w-lg bg-white border p-6 rounded-xl shadow-lg relative">
              ...
              {/* Bouton valider */}
              <button
                className="bg-green-600 hover:bg-green-700 cursor-pointer justify-center w-full items-center px-4 py-2 rounded text-white"
                onClick={() => {
                  if (!selectedClient) {
        ...
        {!openPanier && (
          <button
            ...
            className="fixed lg:bottom-4 bottom-16 right-6 z-50 cursor-pointer bg-gray-100 text-black px-4 py-3 rounded-full shadow-lg hover:bg-blue-200 transition"
          >
            🛒
            {totalQuantite > 0 && (
