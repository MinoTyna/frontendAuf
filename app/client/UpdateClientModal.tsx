      ...
      <div className="bg-white p-6 rounded-xl shadow-xl w-full max-w-2xl relative">
        ...
        <div className="mt-3">
          ...
          {client.Client_photo_url && (
            <img
              src={client.Client_photo_url || "/images.jpg"}
              alt={`${client.Client_nom} ${client.Client_prenom}`}
              className="w-20 h-20 object-cover rounded-full border mt-2 bg-gray-200"
              onError={(e) => {
                (e.currentTarget as HTMLImageElement).src = "/images.jpg";
              }}
            />
          )}
        </div>
