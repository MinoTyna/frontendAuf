...
export default function ClientPage() {
  ...
  return (
    <>
      ...
      <div className="w-full  min-h-screen  flex flex-col gap-6  bg-gradient-to-br from-red-400/50 to-blue-600/90  ">
        {/* <h1 className="md:text-2xl font-bold text-center">Liste de Clients</h1> */}
        {/* Ligne: Search + Bouton Ajouter */}
        <div className="flex flex-col md:flex-row justify-between items-center mt-2 p-3 mb-2 gap-3">
          ...
          <>
            ...
            {(role === "vendeur" || role === "admin") && (
              <div className="hidden md:block p-4 lg:mt-[-22px]  ">
                <Tableau
                  headers={["Image", "Nom", "Prenom", "Cin", "Telephone"]}
                  colonnesAffichees={[
                    "Client_photo",
                    "Client_nom",
                    "Client_prenom",
