...
export default function DetailClientPage() {
  ...
  return (
    <div className="bg-gradient-to-br from-red-400/50 to-blue-600/90 w-full min-h-screen p-4">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-1 rounded-lg shadow space-y-4">
            <h2 className="text-lg font-semibold text-blue-600 flex items-center gap-2">
              <span>👤</span> Informations : {client.client.nom}{" "}
              {client.client.prenom}
            </h2>
          ...
          <div className="flex justify-between items-center mb-3">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-3 py-1 bg-blue-600 text-white rounded cursor-pointer hover:bg-blue-700 transition"
