...
type Responsable = {
  ...
  Responsable_photo_url: string | null;
};
...
export default function ProfilResponsable() {
  ...
  return (
    <div className="bg-gradient-to-br from-red-400/50 to-blue-600/90 min-h-screen py-10">
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  {imagePreview ? (
                    ...
                    <img
                      src={responsable.Responsable_photo_url ?? undefined}
